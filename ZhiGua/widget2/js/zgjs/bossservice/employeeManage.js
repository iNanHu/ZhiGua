...
function add_employee_id() {
	...
	if (validator_number(m_add_employee_id) && validator_varLength("员工编号", m_add_employee_id, 12)) {
...
function add_employee() {
	...
	ajaxSend("WechatBossEmployee_addEmployee", data, "GET", "JSON", true, "_init_listview_employee_manage");
}
