...
function sendfeedbackInfo() {
	var cust_feedbackInfo = $('#cust_feedbackInfo').val();
	if (cust_feedbackInfo != "") {
		var data = {
			"userFeedback.feedbackInfo" : cust_feedbackInfo
		};
		ajaxSend("WechatCustMy_addFeedback", data, "GET", "JSON", true, null);
		close_win();
	} else {
