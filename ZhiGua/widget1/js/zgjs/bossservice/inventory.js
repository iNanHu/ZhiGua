...
function add_inventory_shop(shopCode, shopName) {
	...
	$('#span_inventory_shop_name').attr("style","color: black");
...
function _create_listview_inventory_goods_unit() {
	...
	for (var i = 0; i < goodsArray.length; i++) {
		...
		if (goodsCount < 0) {
			...
			jian_liEle = $("<li class='jian' style='background-color: #f9ecec' onclick='_inventory_jian_number(" + i + ")'><i class='icon icon-minus'></i></li>");
			buy_num_liEle = $("<li class='value gBuyNum' style='background-color: #f9ecec' id='_buy_num_" + goodsCode + "'>" + goodsCount + "</li>");
			jia_liEle = $("<li class='jia' style='background-color: #f9ecec' onclick='_inventory_jia_number(" + i + ")'><i class='icon icon-plus'></i></li>");
		}
...
function clear_inventory() {
	...
	$('#span_inventory_shop_name').attr("style","color: #cacaca");
