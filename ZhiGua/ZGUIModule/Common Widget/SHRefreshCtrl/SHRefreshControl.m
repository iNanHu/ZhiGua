...
@interface SHRefreshControl () <UIScrollViewDelegate>
...
@implementation SHRefreshControl
...
{
    return [SHRefreshControl attachToScrollView:scrollView
                                                   target:target
...
{
    SHRefreshControl *refreshControl = [[SHRefreshControl alloc] init];
